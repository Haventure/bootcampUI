  ...
  return (<>
    <nav className="sticky top-0 bg-[#461A42] z-10 w-full shadow-lg">
      <div className="max-w-screen-xl p-4 mx-auto flex items-center justify-between">
        ...
        <div>
          <Button variant="ghost" className="text-white text-xs font-semibold h-8">Join a game</Button>
          <Button variant="secondary" className="text-[#090909] text-xs font-semibold h-8">Sign up</Button>
        </div>
