...
const SignIn = () => {
  return (
    <div className="">
      <div
        className="min-h-screen w-full flex flex-col items-center  bg-gray-100 relative"
        style={{
          backgroundImage:
      ...
      >
        <div className="flex flex-col items-center justify-center w-full pt-[68px] pb-[32px]">
          {/* Box Div */}
          <div className="flex flex-col justify-center items-center text-center rounded-[12px] mx-auto relative bg-white shadow-2xl px-10 pb-10 z-1 w-[440px] ">
            <div className="w-full pt-[40px]">
              <div className="w-full">
                <div className="w-full">
                  <form action="" className="w-full">
                    <div className="flex justify-center text-center items-center w-full pb-[32px]">
                      <svg
                    ...
                    <div className=" w-full">
                      <div className="flex flex-col justify-center text-center items-center">
                        <h1 className="text-2xl text-[#242424] font-semibold mb-[4px]">
                          Sign in
                        </h1>
                        <p className="text-[#424242] text-[14px] pt-[3px]">
                      ...
                      <div className="w-full">
                        <div className="flex flex-col items-start pt-[32px] w-full">
                          ...
                          <Link
                            href="#"
                            className="text-[#0f6cbd] font-[600] text-sm hover:underline pt-[10px]"
                          >
                        ...
                        <div className="pt-[32px]">
                          <button
                            type="submit"
                            className="w-full text-[14px] bg-[#0f6cbd] hover:bg-blue-900 text-white font-semibold py-[8.5px] px-4 rounded"
                          >
                            Next
                          </button>
                        </div>
                      ...
                      <div className="flex justify-center text-center items-center pt-[31px] ">
                        <span className="text-[14px] font-[400] text-[#424242]">
                          New to Microsoft?{" "}
                        </span>
                        <Link
                          href="#"
                          className="text-[14px] ml-[3px] text-[#0f6cbd] hover:underline font-[600]"
                        >
                          Create an account
                        </Link>
                      </div>
